<div class="w-full mt-15 p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="bg-indigo-100 border-l-4 border-indigo-500 text-indigo-700 p-4 w-full" role="alert">
            <p class="font-bold"><i class="fas fa-layer-group"></i> Editar Nivel | {{$level}}</p>
          </div>
...
<form wire:submit.prevent="actualizarNivel"  enctype="multipart/form-data">
    ...
    <div class="flex justify-center items-center mb-5 gap-6">
        <div class="upload-area my-3" id="uploadArea" wire:ignore>
            ...
            <label for="fileInput" class="btn bg-blue-700 me-2 mb-4 text-white" tabindex="0">
                <span class="d-none d-sm-block my-3">Nuevo logo</span>
            ...
            <img id="preview" class="mt-3 d-none" style="max-width: 100px;">
        </div>

        <div class="logo-anterior">
            <h5 class="text-center">Vista previa del logo</h5>
            <img src="{{ asset('storage/levels/'.$imagen) }}" alt="Vista previa" style="max-width: 100px;">
        </div>
    </div>
