<div class="w-full mt-15 p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="bg-indigo-100 border-l-4 border-indigo-500 text-indigo-700 p-4 w-full" role="alert">
            <p class="font-bold"> <i class="fa-regular fa-user"></i> Nuevo supervisor</p>
          </div>
...
<form wire:submit.prevent="guardarSupervisor">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="zona" wire:model.live="zona" placeholder="Ingrese la zona" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            @error('zona')
            <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-5">
            ...
            <input type="text" id="sector"  wire:model.live="sector" placeholder="Ingrese el sector" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            @error('sector')
            <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
