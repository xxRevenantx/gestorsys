...
<div class="w-full mt-15 p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <div class="flex items-center justify-between mb-4">
        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Editar supervisor
            ...
            <span class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-gray-700 dark:text-blue-400 border border-blue-400">
                {{$supervisor->nombre}} {{$supervisor->apellido_paterno}} {{$supervisor->apellido_materno}}</h5>
            </span>
   ...
   <div class="flow-root my-7">
    ...
    <form wire:submit.prevent="actualizarSupervisor">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div class="mb-5">
                <label for="zona" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Zona</label>
                <input type="text" id="zona" wire:model="zona" placeholder="Ingrese la zona" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                @error('zona')
                <div class="text-red-500">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-5">
                ...
                <input type="text" id="sector"  wire:model="sector" placeholder="Ingrese el sector" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                @error('sector')
                <div class="text-red-500">{{ $message }}</div>
                @enderror
            </div>
