<div class="rounded-lg shadow-lg px-4 py-4">
    ...
    <div class="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border">
            <div class="flex justify-end p-4">
                <button wire:click="openModal" class="flex items-center px-4 py-2 text-white bg-red-500 rounded-lg hover:bg-red-700">
                    <i class="mdi mdi-file-pdf-outline mr-2"></i> Descargar lista
                </button>
            </div>

            @if ($showModal)
            <div class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full ">
