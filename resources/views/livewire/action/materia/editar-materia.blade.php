...
<section class=" py-1">
    <div class="w-full lg:w-12/12 px-4 mx-auto mt-3">

      <div class="relative flex flex-col min-w-0 break-words w-full mb-6 rounded-lg border-0">

        <div class="rounded-t bg-white mb-0 px-6 py-6">
            <a href="{{ url()->previous() }}" wire:ignore class="text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4
          ...
          <div class="text-center flex justify-between">
            ...
            <h6 class="text-blueGray-700 text-xl font-bold mt-5">
             MODIFICAR MATERIA
            </h6>
